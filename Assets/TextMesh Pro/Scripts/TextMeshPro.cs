...
namespace TMPro
{
    ...
    //public enum TextAlignmentOptions { Top = 0, Center = 1, Baseline = 2, Bottom = 4, Normalized = 8, Left = 16, Right = 32, Justified = 64, 
    //                                   TopLeft = Top + Left, BottomLeft = Bottom + Left, BaselineLeft = Baseline + Left,
    //                                   TopRight = Top + Right, BottomRight = Bottom + Right, BaselineRight = Baseline + Right,
    //                                   TopJustified = Top + Justified, BottomJustified = Bottom + Justified, BaselineJustified = Baseline + Justified,
    //                                   TopNormalized = Top + Normalized, BottomNormalized = Bottom + Normalized, BaselineNormalized = Baseline + Normalized };                         
