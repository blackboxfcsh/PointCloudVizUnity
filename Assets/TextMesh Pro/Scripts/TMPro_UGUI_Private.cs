        ...
        */
        ...
        {       
            ...
            if (havePropertiesChanged || m_fontAsset.propertiesChanged || m_isLayoutDirty)
            {
                ...
                if (IsRectTransformDriven && m_isCalculateSizeRequired) // && m_isEnabled)
                {
        ...
        void GenerateTextMesh()
        {
            ...
            for (int i = 0; i < m_characterCount; i++)
            {
                ...
                if (isUnderline)
                {
                    if (beginUnderline == false && currentCharacter != 32 && currentCharacter != 10)
                    {
                        beginUnderline = true;
